...
Analysis Worksheets
Sheet2: Regional sales summary (North East, North West, South East)
Sheet3: Customer-wise sales analysis (Top 10 customers)
Sheet4: Year and month-wise sales breakdown (2021-2022)
Sheet5: Delivery person performance by region
Sheet8: Regional sales percentage distribution
Sheet9: Comprehensive regional analysis with cost price and profit calculations
Pivot Table: Multiple pivot tables summarizing various aspects of sales data
Dashboard
...
Central	41,819.19	19.59%
North East	41,084.96	19.24%
...
Sales by region through bar charts
...
Delivery personnel performance monitoring
...
Multiple pivot tables provide different perspectives on the sales data
Profit calculations are included (Selling Price - Cost Price)
This Excel project serves as a comprehensive sales analysis tool for Chol's Supermarket, enabling data-driven decision making for business optimization.
